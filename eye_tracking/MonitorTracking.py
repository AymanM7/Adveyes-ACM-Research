...
screen_position_file = "C:\\Users\\legab\\Downloads\\combined_integration\\eye_tracking\\screen_position.txt"
# ===== NEW: NDJSON output for gaze records =====
import pathlib

# Per-session output: create folder and unique filename (timestamped)
out_dir = pathlib.Path(r"C:\Users\legab\Downloads\combined_integration\eye_tracking\gaze_sessions")
